...
var jsPsychVisualArrayStimuli = (function (jspsych) {
    'use strict';


  const info = {
  //plugin.info = {
    name: 'visual-test-stimuli',
    description: '',
    parameters: {
      set_size: {
  ...
  class VisualArrayStimuliPlugin {
    constructor(jsPsych) {
...
VisualArrayStimuliPlugin.info= info;
return VisualArrayStimuliPlugin;
