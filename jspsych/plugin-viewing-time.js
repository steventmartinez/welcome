...
var jsPsychViewingTime = (function (jspsych) {
    'use strict';
  
    const info = {
      name: 'instructions-min-viewing-time',
      description: '',
      parameters: {
        pages: {
        ...
        min_viewing_time: {
          ...
          pretty_name: 'Minimum viweing time',
          default: null,
          description: 'Minimum viewing time for each page, in milliseconds. If a value is provided, then the next button will be disabled and key_forward key presses will be '+
          'ignored until the minimum viewing time is reached. If null, the user can immediately move forward to the next page.'
        }
      }
    }
  
    class ViewingTimePlugin {
        constructor(jsPsych) {
    ...
    ViewingTimePlugin.info = info;

    return ViewingTimePlugin;
